...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Ishika ダ ᴍᴜsɪᴄ")

OWNER_ID = list(map(int, getenv("OWNER_ID", "6005478410").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/kundanmeghalove")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/legend_logger")
